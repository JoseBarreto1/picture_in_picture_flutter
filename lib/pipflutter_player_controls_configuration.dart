...
class PipFlutterPlayerControlsConfiguration {
  ...
  final List<PipFlutterPlayerOverflowMenuItem> overflowMenuCustomItems;
  ...
  factory PipFlutterPlayerControlsConfiguration.cupertino() {
    return const PipFlutterPlayerControlsConfiguration(
