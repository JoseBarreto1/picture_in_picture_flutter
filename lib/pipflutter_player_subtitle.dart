...
class PipFlutterPlayerSubtitle {
  ...
  static PipFlutterPlayerSubtitle _handle2LinesSubtitles(List<String> scanner) {
    try {
      ...
      PipFlutterPlayerUtils.log("Failed to parse subtitle line: $scanner");
      return PipFlutterPlayerSubtitle._();
    }
  }

  static PipFlutterPlayerSubtitle _handle3LinesAndMoreSubtitles(
  ...
  static Duration _stringToDuration(String value) {
    try {
      ...
      PipFlutterPlayerUtils.log("Failed to process value: $value");
      return const Duration();
    }
  }
