...
///of player.
class PipFlutterPlayerConfiguration {
  ...
  final PipFlutterPlayerRoutePageBuilder? routePageBuilder;

  /// Defines a event listener where video player events will be send
  final Function(PipFlutterPlayerEvent)? eventListener;

  ///Defines subtitles configuration
  final PipFlutterPlayerSubtitlesConfiguration subtitlesConfiguration;
  ...
  ///will be used.
  final List<PipFlutterPlayerTranslations>? translations;
  ...
  ///[PipFlutterPlayerController] on [PipFlutterPlayer] dispose. When it's true and
  ///[PipFlutterPlayerController] instance has been attached to [PipFlutterPlayer] widget
  ///and dispose has been called on [PipFlutterPlayer] instance, then
  ///[PipFlutterPlayerController] will be disposed.
  ...
  PipFlutterPlayerConfiguration copyWith({
    double? aspectRatio,
    bool? autoPlay,
    Duration? startAt,
    bool? looping,
    ...
    PipFlutterPlayerRoutePageBuilder? routePageBuilder,
    Function(PipFlutterPlayerEvent)? eventListener,
    PipFlutterPlayerSubtitlesConfiguration? subtitlesConfiguration,
    PipFlutterPlayerControlsConfiguration? controlsConfiguration,
    BoxFit? fit,
    double? rotation,
    Function(double visibilityFraction)? playerVisibilityChangedBehavior,
    List<PipFlutterPlayerTranslations>? translations,
    ...
    return PipFlutterPlayerConfiguration(
